...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/Housing-Data-test-kk21/master/prepared_data.csv')
features = tpot_data.drop('target', axis=1)
training_features, testing_features, training_target, testing_target = \
            train_test_split(features, tpot_data['target'], random_state=None)

# Average CV score on the training set was: -54631.206823519875
exported_pipeline = DecisionTreeRegressor(max_depth=7, min_samples_leaf=19, min_samples_split=4)
...
######################
# User defined values
title = 'Housing-Data for Streamlit'
encoder_location = 'https://github.com/karthikreddykuna/Housing-Data-test-kk21/blob/master/encoder.pkl?raw=true'
